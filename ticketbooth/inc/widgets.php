...
if ( ! function_exists( 'understrap_widgets_init' ) ) {
	...
	function understrap_widgets_init() {
		...
		register_sidebar( array(
			'name'          => __( 'Home Page Sidebar #1', 'ticketbooth' ),
			'id'            => 'homepagesidebarone',
			'description'   => 'First widget on the homepage sidebar bar',
			'before_widget'  => '<div id="%1$s" class="sidebar-widget %2$s '. understrap_slbd_count_widgets( 'homepagesidebarone' ) .'">',
			'after_widget'   => '</div><!-- .footer-widget -->',
			'before_title'   => '<h3 class="widget-title">',
			'after_title'    => '</h3>',
		) );
